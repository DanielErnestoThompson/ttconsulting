...
!function(t, e) {
    ...
    class c extends a {
        ...
        onInit() {
            ...
            t.lookAt(0, 0, 0),
            this.scene.add(t);
            var e, s, o, n, r, h, a, c = this.starsGeometry = new l.BufferGeometry, d = this.options.spacing;
            const p = [];
            for (e = o = -30; o <= 30; e = ++o)
                for (s = n = -30; n <= 30; s = ++n)
        ...
        onUpdate() {
            ...
            i.lookAt(0, 0, 0),
            this.linesMesh && (this.linesMesh.rotation.z += .002,
            this.linesMesh.rotation.x += 8e-4,
            this.linesMesh.rotation.y += 5e-4)
        }
        onMouseMove(t, e) {
            this.camera.tx = 100 * (t - .5),
            this.camera.ty = 50 + 50 * e
        }
        onRestart() {
...
>>>>>>> bc5e89956a9477413d260f62414b947250f802f7
